...
class NotificationsPresenter {
    ...
    fileprivate func loadData(page: Int, in section: NotificationsSection) -> Promise<(Bool, NotificationViewDataStruct)> {
        return Promise { fulfill, reject in
            ...
            self.notificationsAPI.retrieve(page: page, notificationType: section.notificationType).then { meta, result -> Promise<NotificationViewDataStruct> in
    ...
    fileprivate func merge(old: NotificationViewDataStruct, new: [Notification]) -> Promise<NotificationViewDataStruct> {
        ...
        return Promise { fulfill, _ in
            self.usersAPI.retrieve(ids: Array(usersQuery), existing: []).then { users -> Void in
    ...
    func markAllAsRead() {
        ...
        self.notificationsAPI.markAllAsRead().then { _ -> Void in
